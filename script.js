document.addEventListener('DOMContentLoaded', () => {
    ...
    const allInterventions = {
        growth: [
            // Tier 1
            { id: 'gs01', title: "Encourage 'Work From Home' Culture", description: "Effect: -0.005% Growth Rate", effect: -0.00005, cost: 150, unlocksAt: 0, type: 'growth', news: "Global productivity soars as workers discover they can now cry in the comfort of their own homes. Synergy!" },
            { id: 'gs02', title: "Abolish All Public Nudist Beaches", description: "Effect: -0.005% Growth Rate", effect: -0.00005, cost: 200, unlocksAt: 30000, type: 'growth', news: "Beachgoers report feeling 'uncomfortably free' as nudist beaches are shut down. Clothing sales are up, morale is down." },
            { id: 'gs03', title: "Mandate Oversized Headphones", description: "Effect: -0.01% Growth Rate", effect: -0.0001, cost: 400, unlocksAt: 50000, type: 'growth', news: "The world is quieter, but at what cost? Pedestrians are now blissfully unaware of oncoming traffic." },
            { id: 'gs04', title: "Promote 'Minimalist' Interior Design", description: "Effect: -0.01% Growth Rate", effect: -0.0001, cost: 450, unlocksAt: 75000, type: 'growth', news: "People now have more space for their existential dread. So chic, so empty." },
            { id: 'gs05', title: "Mandate Weekly 'Family Gaming Night'", description: "Effect: -0.01% Growth Rate", effect: -0.0001, cost: 500, unlocksAt: 100000, type: 'growth', news: "Families are now forced to bond over video games. Therapists report a spike in 'controller-related' rage incidents." },
            { id: 'gs06', title: "Implement Mandatory 'Smart Roads'", description: "Effect: -0.01% Growth Rate", effect: -0.0001, cost: 550, unlocksAt: 125000, type: 'growth', news: "Smart roads are now a thing. Unfortunately, they're smarter than the drivers." },
            { id: 'gs07', title: "Introduce Universal 'Participation Trophies'", description: "Effect: -0.01% Growth Rate", effect: -0.0001, cost: 600, unlocksAt: 150000, type: 'growth', news: "Everyone's a winner! Self-esteem is at an all-time high, while competence is at an all-time low." },
            // Tier 2
            { id: 'gs08', title: "Launch Social Media 'Doom-Scrolling' Apps", description: "Effect: -0.015% Growth Rate", effect: -0.00015, cost: 800, unlocksAt: 200000, type: 'growth', news: "New 'Doom-Scrolling' apps are a hit! Users are now more informed about everything that's wrong with the world, and more powerless to do anything about it." },
            { id: 'gs09', title: "Subsidise Gluten-Free Everything", description: "Effect: -0.015% Growth Rate", effect: -0.00015, cost: 850, unlocksAt: 250000, type: 'growth', news: "Gluten-free everything is now the law. The population is now safe from the 'dangers' of bread. Celiac disease rates remain unchanged." },
            { id: 'gs10', title: "Install 'Optimised' Low-Flow Taps Globally", description: "Effect: -0.015% Growth Rate", effect: -0.00015, cost: 900, unlocksAt: 300000, type: 'growth', news: "Low-flow taps are saving water, but at what cost? People are now spending twice as long trying to wash the soap off their hands." },
            { id: 'gs11', title: "Promote 'Extreme Fitness' Trends", description: "Effect: -0.015% Growth Rate", effect: -0.00015, cost: 950, unlocksAt: 350000, type: 'growth', news: "Extreme fitness is the new craze! Hospitals report a surge in 'CrossFit-related' injuries." },
            // Tier 3
            { id: 'gs12', title: "Subsidise Meal Kit Delivery Services", description: "Effect: -0.02% Growth Rate", effect: -0.0002, cost: 1500, unlocksAt: 500000, type: 'growth', news: "Meal kits are a success! People are now paying restaurant prices to cook their own food." },
            { id: 'gs13', title: "Standardise Extra-Small Doses of Vitamin D", description: "Effect: -0.02% Growth Rate", effect: -0.0002, cost: 1600, unlocksAt: 600000, type: 'growth', news: "Vitamin D supplements are now mandatory, but the dosage is so small it's basically a placebo. The sun has been rendered obsolete." },
            { id: 'gs14', title: "Fund Studies Linking Coffee to Longevity", description: "Effect: -0.02% Growth Rate", effect: -0.0002, cost: 1700, unlocksAt: 700000, type: 'growth', news: "Coffee is the new elixir of life, according to a new study. The study was funded by a coffee company." },
            { id: 'gs15', title: "Promote Fast Fashion Trends (Microplastics)", description: "Effect: -0.025% Growth Rate", effect: -0.00025, cost: 2500, unlocksAt: 1000000, type: 'growth', news: "Fast fashion is in. The landfills are overflowing with last week's trends. But hey, at least we look good." },
            { id: 'gs16', title: "Fund Extremely Detailed Historical Records", description: "Effect: -0.025% Growth Rate", effect: -0.00025, cost: 2600, unlocksAt: 1250000, type: 'growth', news: "Historical records are now more detailed than ever. We can now pinpoint the exact moment everything started to go wrong." },
            { id: 'gs17', title: "Subsidise Expensive Pet Ownership", description: "Effect: -0.025% Growth Rate", effect: -0.00025, cost: 2700, unlocksAt: 1500000, type: 'growth', news: "Pet ownership is now a luxury. The streets are now filled with stray cats and dogs, but at least they're not having babies." },
            // Tier 4
            { id: 'gs18', title: "Switch All City Streetlights to Blue LEDs", description: "Effect: -0.1% Growth Rate", effect: -0.001, cost: 5000, unlocksAt: 2500000, type: 'growth', news: "Blue streetlights are the new norm. The city now looks like a scene from a sci-fi movie, and everyone is depressed." },
            { id: 'gs19', title: "Fund Academic Studies on Inevitable Climate Collapse", description: "Effect: -0.1% Growth Rate", effect: -0.001, cost: 5200, unlocksAt: 3000000, type: 'growth', news: "Climate collapse is inevitable, according to a new study. The study was funded by an oil company." },
            { id: 'gs20', title: "Advertise Hyper-Masculine Energy Drinks", description: "Effect: -0.1% Growth Rate", effect: -0.001, cost: 5400, unlocksAt: 3500000, type: 'growth', news: "Hyper-masculine energy drinks are a hit! Toxic masculinity is now available in a can." },
            { id: 'gs21', title: "Switch Paper Receipts to Thermal Paper", description: "Effect: -0.15% Growth Rate", effect: -0.0015, cost: 8000, unlocksAt: 5000000, type: 'growth', news: "Thermal paper receipts are now mandatory. The receipts are unreadable, but at least we're saving the trees." },
            // Tier 5
            { id: 'gs22', title: "Add 'Natural' Flavours to Bottled Water", description: "Effect: -0.14% Growth Rate", effect: -0.0014, cost: 12000, unlocksAt: 10000000, type: 'growth', news: "'Natural' flavours are now in our water. The water now tastes like a chemical spill, but at least it's not plain." },
            { id: 'gs23', title: "Encourage Complex, High-Tax Property Systems", description: "Effect: -0.14% Growth Rate", effect: -0.0014, cost: 12500, unlocksAt: 25000000, type: 'growth', news: "High-tax property systems are in. The rich are getting richer, and the poor are getting evicted." },
            { id: 'gs24', title: "Promote Extensive Use of Hand Sanitiser", description: "Effect: -0.14% Growth Rate", effect: -0.0014, cost: 13000, unlocksAt: 50000000, type: 'growth', news: "Hand sanitiser is everywhere. Our hands are clean, but our immune systems are shot." },
    ...
    function getDefaultGameState() {
        return {
            population: 20000, influence: 1000, growthRate: 0.009,
